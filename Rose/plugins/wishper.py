...
lengths = 200
IMG = "https://telegra.ph/file/528e50865cd1544dd627a.jpg"
...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@F_I0_Bot [@username|@] text`")
        description = "Usage: @F_I0_Bot [@username|@] text"
        button = InlineKeyboardButton(
            "Learn more...",
            url="https://t.me/R40_bot?start=learn"
        )
